...
class WWCommand extends command.Command
 {
    constructor(client)
    {
        super(client, {
            ...
            examples: ["`!ww start` (Start Game)", "`!ww ranks` (Check Local Leaderboards)", "`!ww profile [@User (optional)]` (Check how many tokens you or another user have and which countries you or another user have conquered)", "`!ww collect` (Gather Resources)", "`!ww list` (List out all countries)", "`!ww buy <country-name>` (Conquer a country)", "`!ww info <country-name>` (Get info of a country)"]
        });
    }
