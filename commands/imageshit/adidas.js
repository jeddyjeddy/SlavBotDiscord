...
class AdidasCommand extends command.Command
 {
    constructor(client)
    {
        super(client, {
            ...
            examples: ["`!adidas`", "`!adidas avatar`", "`!adidas @User`"]
        });
    }
    ...
    async run(message, args)
    {
        ...
        if(args.toString().toLowerCase() != "avatar" && !otherUser)
        {
            ...
            .then(messages => {
                ...
                Jimp.read("adidas.png").then(function (adidasImage) {
                    console.log("got image");
                    Jimp.read(url).then(function (userImage) {
                        console.log("got avatar");

                        adidasImage.resize(userImage.bitmap.width, Jimp.AUTO)                       
                        ...
                        userImage.write(file, function(error){
                            ...
                            console.log(file);
                            message.channel.send("***Branding Complete***", {
                                files: [file]
                            }).then(function(){
