                        ...
                        if(!connection.speaking)
                        {
                            fs.readdir("audio", (err, files) => {
                                ...
                                for(var i = 0; i < files.length; i++)
                                {
                                    ...
                                    {
                                        playing = true;
                                        connection.playFile("/root/SlavBotDiscord/audio/" + files[i]).catch(error => console.log("Play Error - " + error));
                                    }
                                }
                        ...
                        if(!message.guild.voiceConnection.speaking)
                        {
                            fs.readdir("audio", (err, files) => {
                                ...
                                for(var i = 0; i < files.length; i++)
                                {
                                    ...
                                    {
                                        playing = true;
                                        message.guild.voiceConnection.playFile("/root/SlavBotDiscord/audio/" + files[i]).catch(error => console.log("Play Error - " + error));
                                    }
                                }
