                   ...
                   /* else if (args.toLowerCase().startsWith("trade"))
                            ...
                            for(var index = 0; index < database.length; index++)
                            {
                                if(database[index].id == ID)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        message.channel.send("", {embed: {title: "***" + database[index].name + " - " + database[index].id + "***", description: extraDetails, color: 13070337, timestamp: timestamp, image: {url: database[index].image.url}, footer: {icon_url: message.client.user.avatarURL,text: "Sent on"}}}).catch(error => console.log("Send Error - " + error));
                                    }
                                }
                            }
                        }
                        ...
                        {                                                
                            ...
                            for(var index = 0; index < database.length; index++)
                            {
                                if(database[index].id == ID)
                                {
                                    ...
                                    if(extraDetails == "")
                                    {
                                        message.channel.send("<@" + message.author.id + "> ***Silver Character Pack Purchased***", {embed: {title: "***You Have Found A Silver " + database[index].name + " - " + database[index].id + "***", description: details, color: 7566195, timestamp: timestamp, image: {url: database[index].image.url}, footer: {icon_url: message.client.user.avatarURL,text: "Sent on"}}}).catch(error => console.log("Send Error - " + error));
                                    }
                                    else
                                    {
                                        ...
                                        message.channel.send("", {embed: {title: "***" + database[index].name + " - " + database[index].id + "***", description: extraDetails, color: 7566195, timestamp: timestamp, image: {url: database[index].image.url}, footer: {icon_url: message.client.user.avatarURL,text: "Sent on"}}}).catch(error => console.log("Send Error - " + error));
                                    }
                                }
                            }
                        }
                        ...
                        {                                                
                            ...
                            for(var index = 0; index < database.length; index++)
                            {
                                if(database[index].id == ID)
                                {
                                    ...
                                    if(extraDetails == "")
                                    {
                                        message.channel.send("<@" + message.author.id + "> ***Gold Character Pack Purchased***", {embed: {title: "***You Have Found A Gold " + database[index].name + " - " + database[index].id + "***", description: details, color: 16436562, timestamp: timestamp, image: {url: database[index].image.url}, footer: {icon_url: message.client.user.avatarURL,text: "Sent on"}}}).catch(error => console.log("Send Error - " + error));
                                    }
                                    else
                                    {
                                        ...
                                        message.channel.send("", {embed: {title: "***" + database[index].name + " - " + database[index].id + "***", description: extraDetails, color: 16436562, timestamp: timestamp, image: {url: database[index].image.url}, footer: {icon_url: message.client.user.avatarURL,text: "Sent on"}}}).catch(error => console.log("Send Error - " + error));
                                    }
                                }
                            }
                        }
                                ...
                                {                                                
                                    ...
                                    for(var index = 0; index < database.length; index++)
                                    {
                                        if(database[index].id == ID)
                                        {
                                            ...
                                            if(extraDetails == "")
                                            {
                                                message.channel.send("<@" + message.author.id + "> ***Platinum Character Purchased***", {embed: {title: "***You Purchased A Platinum " + database[index].name + " - " + database[index].id + "***", description: details, color: 13487565, timestamp: timestamp, image: {url: database[index].image.url}, footer: {icon_url: message.client.user.avatarURL,text: "Sent on"}}}).catch(error => console.log("Send Error - " + error));
                                            }
                                            else
                                            {
                                                ...
                                                message.channel.send("", {embed: {title: "***" + database[index].name + " - " + database[index].id + "***", description: extraDetails, color: 13487565, timestamp: timestamp, image: {url: database[index].image.url}, footer: {icon_url: message.client.user.avatarURL,text: "Sent on"}}}).catch(error => console.log("Send Error - " + error));
                                            }
                                        }
                                    }
                                }
                        ...
                        if(validID)
                        {
                            for(var index = 0; index < database.length; index++)
                            {
                                if(database[index].id == ID)
                                {
                                    ...
                                    if(extraDetails == "")
                                    {
                                        message.channel.send("***" + database[index].name + " - " + database[index].id + "***", {embed: {title: "***" + database[index].name + " - " + database[index].id + "***", description: details, color: 8388863, timestamp: timestamp, image: {url: database[index].image.url}, footer: {icon_url: message.client.user.avatarURL,text: "Sent on"}}}).catch(error => console.log("Send Error - " + error));
                                    }
                                    else
                                    {
                                        ...
                                        message.channel.send("", {embed: {title: "***" + database[index].name + " - " + database[index].id + "***", description: extraDetails, color: 8388863, timestamp: timestamp, image: {url: database[index].image.url}, footer: {icon_url: message.client.user.avatarURL,text: "Sent on"}}}).catch(error => console.log("Send Error - " + error));
                                    }
                                }
                            }
                        }
                    ...
                    else if(args.toLowerCase().startsWith("profile"))
                    {
                        ...
                        else
                        {
                            ...
                            message.channel.send("", {embed: {title: "***Calamity Cards Profile for " + user.username + "***", description: "***__Bronze Characters__***\nUnique Bronze Characters Owned: " + numberWithCommas(uniqueBronzeChars) + "/" + numberWithCommas(maxID) + "\nTotal Bronze Characters Owned: " + numberWithCommas(totalBronzeChars) + "\n\n***__Silver Characters__***\nUnique Silver Characters Owned: " + numberWithCommas(uniqueSilverChars) + "/" + numberWithCommas(maxID) + "\nTotal Silver Characters Owned: " + numberWithCommas(totalSilverChars) + "\n\n***__Gold Characters__***\nUnique Gold Characters Owned: " + numberWithCommas(uniqueGoldChars) + "/" + numberWithCommas(maxID) + "\nTotal Gold Characters Owned: " + numberWithCommas(totalGoldChars) +  + "\n\n***__Platinum Characters__***\nUnique Platinum Characters Owned: " + numberWithCommas(uniquePlatinumChars) + "/" + numberWithCommas(maxID) + "\nTotal Platinum Characters Owned: " + numberWithCommas(totalPlatinumChars) + "\n\n***__Overall Characters__***\nOverall Unique Characters Owned: " + numberWithCommas(totalUniqueChars) + "/" + numberWithCommas(maxID*4) + "\nOverall Total Characters Owned: " + numberWithCommas(totalChars) + "\n\nYou currently have " + numberWithCommas(IndexRef.getTokens(user.id)) + " tokens.", color: 16711680, thumbnail: {"url": thumbnail}, timestamp: timestamp, footer: {icon_url: message.client.user.avatarURL,text: "Sent on"}}}).catch(error => console.log("Send Error - " + error));
                        }
                    }
