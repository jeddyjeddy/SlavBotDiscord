...
class CommandRegistry {
	 ...
	 * @param {boolean} [options.eval_=false] - Whether or not to register the built-in eval command
	 ...
	 * @return {CommandRegistry}
	 */
	registerDefaultCommands({ help = true, prefix = true, ping = true, eval_ = false, commandState = true } = {}) {
	...
	resolveGroup(group) {
		...
		console.log('Unable to resolve group.');
		return null;
	}
	...
	resolveCommand(command) {
		...
		console.log('Unable to resolve command.');
		return null;
	}
