...
class ThanosCommand extends command.Command
 {
    ...
    async run(message, args)
    {
        ...
        {
            message.channel.send("<@" + message.author.id + "> This command will kick half the users on this server. To execute the command, use `" + commandPrefix + "thanos snap`.").catch(error => console.log("Send Error - " + error));
        }
    }
}
