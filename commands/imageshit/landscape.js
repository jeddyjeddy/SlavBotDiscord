...
class LandscapeCommand extends command.Command
 {
    constructor(client)
    {
        super(client, {
            name: "landscape",
            group: "imageshit",
            memberName: "landscape",
            description: "Gives a random Image of various landscapes from /r/landscapeimages.",
            examples: ["`!landscape`"]
        });
    }
    ...
    async run(message, args)
    {
        ...
        var url = "https://www.reddit.com/r/landscape/random/.json";
...
module.exports = LandscapeCommand;