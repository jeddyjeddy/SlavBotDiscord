...
class AlbumCommand extends command.Command
 {
    constructor(client)
    {
        super(client, {
            ...
            examples: ["`!album`", "`!album avatar`", "`!album @User`"]
        });
    }
    ...
    async run(message, args)
    {
        ...
        if(args.toString().toLowerCase() != "avatar" && !otherUser)
        {
            ...
            .then(messages => {
                ...
                if(messageID == "")
                {
                    message.channel.send("<@" + message.author.id + "> No image found, use`" + commandPrefix + "help album` for help.").catch(error => {console.log("Send Error - " + error); });
                    
                    return;
                }
                message.channel.send("***taking image***").catch(error => {console.log("Send Error - " + error); });
                Jimp.read("album.png").then(function (albumImage) {
                    ...
                    Jimp.read(url).then(function (userImage) {
                        ...
                        var blank = new Jimp(albumImage.bitmap.width, albumImage.bitmap.height);
                        ...
                        mergedImage.write(file, function(error){
                            ...
                            console.log(file);
                            message.channel.send("***I love this album more than I love myself.***", {
                                files: [file]
                            }).then(function(){
