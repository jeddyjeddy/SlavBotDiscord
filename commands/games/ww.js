                        ...
                        else
                        {
                            ...
                            {  
                                ...
                                if(date.getTime() <= (new Date()).getTime())
                                {
                                    ...
                                    message.channel.send("", {embed: {title: "***Resources Collected***", description: "<@" + message.author.id + "> You have collected ***" + numberWithCommas(collected) + " tokens***\n\n***Max value increase of " + numberWithCommas(maxPercInc) + "%*** _(current max value: " + numberWithCommas(maxValue) + ")_ - Increase the max amount of tokens you can collect by conquering countries with a value greater than 1,000 tokens.\n\n***Collected Value Increase of " + collectedValInc + "%*** - You can increase the value of tokens you have collected. This is only available to those ***[supporting us on Patreon](https://www.patreon.com/merriemweebster)***.\n\n\n***[Patreon supporters also get weekly tokens.](https://www.patreon.com/merriemweebster)***\n\n\n***[You can also purhcase war tokens on our website.](https://slavbot.com/shop)***", color: 65339, timestamp: timestamp, footer: {icon_url: message.client.user.avatarURL,text: "Collected on"}}}).catch(error => console.log("Send Error - " + error));
                                }
                                else
                                {
