...
module.exports = class PingCommand extends Command {
	...
	async run(msg) {
		...
		if(all && msg.author.id == msg.client.owners[0].id)
		{
			var totalShards = msg.client.shard.count;
			msg.client.shard.fetchClientValues('shard.id')
			.then(results => {
				for(var shard in results)
				{
					msg.channel.send(`Shard ${results[shard]} from ${totalShards} shards is online.`)
