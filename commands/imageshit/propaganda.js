...
class PropagandaCommand extends command.Command
 {
    constructor(client)
    {
        super(client, {
            name: "propaganda",
            group: "imageshit",
            memberName: "propaganda",
            description: "Turns an image into Soviet Propaganda. This command takes the last image uploaded, your avatar or the avatar of the user you have mentioned after the command.",
            examples: ["`!propaganda`", "`!propaganda avatar`", "`!propaganda @User`"]
        });
    }
    ...
    async run(message, args)
    {
        ...
        if(args.toString().toLowerCase() != "avatar" && !otherUser)
        {
            ...
            .then(messages => {
                ...
                if(messageID == "")
                {
                    message.channel.send("<@" + message.author.id + "> No image found, , use `" + commandPrefix + "help propaganda` for help.").catch(error => {console.log("Send Error - " + error); });
...
module.exports = PropagandaCommand;
