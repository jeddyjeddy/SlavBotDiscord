...
class YouSeeComradeCommand extends command.Command
 {
    constructor(client)
    {
        super(client, {
            name: "youseecomrade",
            group: "imageshit",
            memberName: "youseecomrade",
            description: "Gives a random Image from /r/YouSeeComrade.",
            examples: ["`!youseecomrade`"]
        });
    }

    async run(message, args)
    {
        var url = "https://www.reddit.com/r/YouSeeComrade/random/.json";
...
module.exports = YouSeeComradeCommand;