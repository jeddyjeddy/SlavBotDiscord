...
class AnimeGirlDabbingCommand extends command.Command
 {
    constructor(client)
    {
        super(client, {
    ...
    {
        var url = "https://www.reddit.com/r/animegirlsdabbing/random/.json";
        request(url, { json: true }, (err, res, redditResponse) => {
            ...
            if(title == "" || title == null)
            {
                title = "***Anime Girl Dabbing Moment***";
            }
            else
            {
                title = "***" + title + "***";
...
module.exports = AnimeGirlDabbingCommand;