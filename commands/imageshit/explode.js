...
class ExplodeCommand extends command.Command
 {
    constructor(client)
    {
        super(client, {
            ...
            group: "imageshit",
            memberName: "explode",
            description: "Adds the Explode effect to an image. Add the effect to the last image uploaded, your avatar or the avatar of the user you mentioned after the command.",
