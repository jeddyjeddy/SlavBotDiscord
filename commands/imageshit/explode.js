...
class ExplodeCommand extends command.Command
 {
    constructor(client)
    {
        super(client, {
            ...
            group: "imageshit",
            memberName: "explode",
            description: "Add the explode effect to an image. Distort the last image uploaded or Distort your avatar or the avatar of the user you mentioned after the command.",
            examples: ["`!explode`", "`!explode avatar`", "`!explode @User`"]
        });
    }
            ...
            .then(messages => {
                ...
                Jimp.read(url).then(function (userImage) {
                    ...
                    Jimp.read("explode.png").then(function (displacementMask) {
                        displacementMask.scale(userImage.bitmap.width, userImage.bitmap.height)
