...
class EmojipastaCommand extends command.Command
 {
    constructor(client)
    {
        super(client, {
            name: "emojipasta",
            group: "textshit",
            memberName: "emojipasta",
            description: "Gives a random emojipasta from /r/emojipasta.",
            examples: ["`!emojipasta`"]
        });
    }
    ...
    {
        var url = "http://www.reddit.com/r/emojipasta/random/.json";
