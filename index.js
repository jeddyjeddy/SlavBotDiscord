...
bot.on("message", (message) => {
    ...
    if(message.content.toLowerCase().indexOf("fuck") > -1 || message.content.toLowerCase().indexOf("bitch") > -1 
      ...
      || message.content.toLowerCase().indexOf("bellend") > -1)
    {
        if(message.author.id != bot.user.id)
        {
            var swearcounter = [];
